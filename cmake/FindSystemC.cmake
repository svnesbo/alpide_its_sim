...
# http://git.greensocs.com/platforms/versatile-pb/blob/1.x/cmake/FindSystemC.cmake
#=============================================================================
...
find_library(SystemC_LIBRARIES
  NAMES "${CMAKE_STATIC_LIBRARY_PREFIX}systemc${CMAKE_STATIC_LIBRARY_SUFFIX}"
  HINTS ${_SYSTEMC_HINTS}
  PATHS ${_SYSTEMC_PATHS}
) 

message( ${CMAKE_STATIC_LIBRARY_PREFIX}systemc${CMAKE_STATIC_LIBRARY_SUFFIX})
