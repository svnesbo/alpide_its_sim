...
#ifndef EVENT_XML_ITS_H
#define EVENT_XML_ITS_H
...
class EventXMLITS : public EventBaseDiscrete {
...
public:
  EventXMLITS(Detector::DetectorConfigBase config,
